...
const CreateGoals = () => {
  ...
  const [exercises, setExercises] = useState([{ exercise_name: '', category: '', sets: '', estimated_time: '' }]);

  const [diets, setDiets] = useState([{ diet_name: '', category: '', quantity: '', total_calories: '' }]);
  ...
  const addExercises = () => {
    setExercises([...exercises, { exercise_name: '', category: '', sets: '', estimated_time: '' }]);
  };
  const  addDiets = () => {
    setDiets([...diets, { exercise_name: '', category: '', sets: '', estimated_time: '' }]);
  };
        ...
        <form onSubmit={activeSection === 'exercise' ? handleExerciseSubmit : handleDietSubmit} className="mt-5 w-50">
          <div className="border border-info p-5">
            <Button
              ...
              style={{
                backgroundColor: activeSection === 'exercise' ? 'orange' : 'white',
...
>
  ...
  <MenuItem value="dinner">Dinner</MenuItem>
          ...
          <Button type="submit" variant="contained" style={{ backgroundColor: '#59a2eb', color: 'white'}} className="mt-4">
            Save
          </Button>
        </form>
      </div>
